...
AuditConnector has 3 methods for explicit audits. Use whichever you prefer.
 ```scala
 connector.sendExplicitAudit("theAuditType", ExampleAuditData("123"))
 connector.sendExplicitAudit("theAuditType", Json.obj("vrn" -> "123", "some" -> Json.obj("nested" -> "value")))
 connector.sendExplicitAudit("theAuditType", Map("vrn" -> "123"))
```
